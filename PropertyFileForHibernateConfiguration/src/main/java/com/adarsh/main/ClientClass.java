...
public class ClientClass {
		...
		public static Session getHibernateSession(){
			 Configuration hibernateConfigurationObject=null;
					try{
								...
								hibernateConfigurationObject.addFile("person.hbm.xml");
					}catch(Exception exceptionObject){
								System.out.println(exceptionObject.getMessage());
								exceptionObject.printStackTrace();
					}
			return hibernateConfigurationObject.buildSessionFactory().openSession();
		}
		...
		public static void displayPerson(Integer[] personId){
			try{
					Session sessionObject=getHibernateSession();
